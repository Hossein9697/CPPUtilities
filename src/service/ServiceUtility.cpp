#include "service/ServiceUtility.hpp"

bool ServiceUtility::isServiceExists(const wchar_t* serviceName)
{
...
int ServiceUtility::getServiceStatus(const wchar_t* serviceName)
{
    SC_HANDLE theService, scm;
...
bool ServiceUtility::startService(const wchar_t* serviceName)
{
    SERVICE_STATUS_PROCESS ssStatus;
...
bool ServiceUtility::stopService(const wchar_t* serviceName)
{
...
bool ServiceUtility::stopDependentServices(SC_HANDLE serviceHandle)
{
    DWORD i;
    DWORD dwBytesNeeded;
    DWORD dwCount;
    ...
    else
    {
        ...
        __try
        {
            ...
            for (i = 0; i < dwCount; i++)
            {
                ...
                // Open the service.
                hDepService = OpenService(serviceHandle,
                                          ess.lpServiceName,
